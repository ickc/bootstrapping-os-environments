...
size_small_iec=$(numfmt --to=iec "${size_small}")
size_large_iec=$(numfmt --to=iec "${size_large}")

echo "Detected smaller device: ${SMALL_DEV} (${size_small_iec})"
echo "Detected larger  device: ${LARGE_DEV} (${size_large_iec})"
